...
//    m_pInputMsgLE->setEchoMode(Password);
    ...
    m_pDelFriendPB = new QPushButton(QString::fromLocal8Bit("删除好友"));
    m_pFlushFriendPB = new QPushButton(QString::fromLocal8Bit("刷新好友"));
    m_pShowOnlineUsrPB = new QPushButton(QString::fromLocal8Bit("显示在线用户"));
    m_pSearchUsrPB = new QPushButton(QString::fromLocal8Bit("查找用户"));
    m_pMsgSendPB = new QPushButton(QString::fromLocal8Bit("信息发送"));
    m_pPrivateChatPB = new QPushButton(QString::fromLocal8Bit("私聊"));
...
{
    m_strSearchName = QInputDialog::getText(this, QString::fromLocal8Bit("搜索")
...
void Friend::flushFriend()
{
    ...
    QString strName = TcpClient::getInstance().loginName(); //获得自己的用户名
    PDU *pdu = mkPDU(0);
...
void Friend::delFriend()
{
    ...
    {
        QString strFriendName = m_pFriendListWidget->currentItem()->text(); //获得Item上的数据
        PDU *pdu = mkPDU(0);
...
void Friend::privateChat()
{
    ...
    {
        QMessageBox::warning(this, QString::fromLocal8Bit("私聊"), QString::fromLocal8Bit("请选择私聊对象"));
    }
}
...
void Friend::groupChat()
{
    ...
    {
        QMessageBox::warning(this, QString::fromLocal8Bit("群聊")
                             , QString::fromLocal8Bit("信息不能为空"));
    }
}
